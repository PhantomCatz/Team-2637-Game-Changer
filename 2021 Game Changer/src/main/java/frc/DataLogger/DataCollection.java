...
{	
    ...
    private final String LOG_HDR_SHOOTER = "time, Trgt-RPM, RPM, avg-vel";
    ...
    public void printInitialData()
    {
        ...
        double data5  = -999.0; //Robot.driveTrain.PID_IZ;
        double data6  = -999.0; //Robot.driveTrain.encCountsToInches;
        double data7  = -999.0; //Robot.driveTrain.currentDrvTrainGear;
        double data8  = -999.0; //Robot.auton.distanceGoal;
        double data9 = -999.0;
        double data10 = -999.0;
        double data11 = -999.0;
        double data12 = -999.0;
